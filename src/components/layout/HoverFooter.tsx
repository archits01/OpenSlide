  ...
  return (
    ...
    >
      ...
      <motion.text
        ...
        dominantBaseline="middle"
        strokeWidth="0.3"
        className="fill-transparent stroke-[#C2185B] font-[helvetica] text-7xl font-bold"
  ...
  return (
    <div
      ...
      style={{
        zIndex: 0,
        background:
          "radial-gradient(125% 125% at 50% 10%, rgba(15,15,17,0.4) 50%, rgba(194,24,91,0.15) 100%)",
      }}
    />
  );
};
