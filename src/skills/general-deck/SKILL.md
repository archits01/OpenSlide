---
name: general-deck
description: General-purpose layout library for presentations that don't fit a specific domain. Used as the default fallback when the classifier cannot confidently route to a domain skill.
---

# Layout Library — General Deck HTML Slides
